...
public class Admin_AidSeeker_Validation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Admin_AidSeeker_Validation.this,MenuForAdmins.class);
        ...
        iv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(checker)
                {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            switch (i) {
                                case DialogInterface.BUTTON_POSITIVE:
                                    if(ContextCompat.checkSelfPermission(Admin_AidSeeker_Validation.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED)
                                    {
                                        saveImage();
                                    }
                                    else
                                    {
                                        ActivityCompat.requestPermissions(Admin_AidSeeker_Validation.this,new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},REQUEST_CODE);
                                    }
                                    break;
                    ...
                    AlertDialog.Builder builder2 = new AlertDialog.Builder(Admin_AidSeeker_Validation.this);
                ...
                {
                    Toast.makeText(Admin_AidSeeker_Validation.this,"No License to download!",Toast.LENGTH_SHORT).show();
                }
            }
        });
        //----
    ...
    public void saveImage()
    {
        ...
        try{
            ...
            Toast.makeText(Admin_AidSeeker_Validation.this, "Downloaded! Review Well!",Toast.LENGTH_SHORT).show();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode == REQUEST_CODE)
        {
            ...
            {
                Toast.makeText(Admin_AidSeeker_Validation.this,"Please Accept The Permission!",Toast.LENGTH_SHORT).show();
            }
        }
    }
